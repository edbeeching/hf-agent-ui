...
For local use, `switch hub` binds to `127.0.0.1` by default. For network use, configure `SWITCH_UI_TOKEN` or run behind a trusted private access layer and set `SWITCH_TRUST_PROXY_AUTH=1`.
